...
export function Hero({ title, subtitle, image, imageAlt, primaryCTA = "Find an Award-Caliber Installer", primaryHref = "/find-an-installer" }: HeroProps) {
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 pt-36 pb-20 md:pt-48 md:pb-28 text-center">
        ...
        >
          ...
          <Link
            href="/topics/real-spray-foam-industry-awards"
