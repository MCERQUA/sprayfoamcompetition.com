...
export const metadata: Metadata = {
  title: "Blog",
  description: "Deeper dives on the real spray foam competitions, quality standards, and costs.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <FadeIn>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              More detail on the real competitions, quality standards, and what things actually cost.
            </p>
          </FadeIn>
        </div>
      </section>
